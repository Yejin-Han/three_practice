...
function App(conf) {
    ...
    function init() {
        ...
        camera = new THREE.PerspectiveCamera(conf.fov, window.innerWidth / window.innerHeight, 1, 1000);
    ...
    function initScene() {
        ...
        let mat = new THREE.MeshLambertMaterial({ color: 0xffffff, side: THREE.DoubleSide }); // 객체의 양 면을 raycasting 하기 위해
    ...
    function initLights() {
        ...
        const lightHelper4 = new THREE.PointLightHelper(light4);
